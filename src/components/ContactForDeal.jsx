...
export default function ContactForDeal() {
    const form = useRef();
  ...
  const { id } = useParams();
  const { products } = useSelector((store) => store.db);
  const selectedProduct = products.find((item) => item.id == id);
  return (
    <Halmet title="Contact For Deal">
      {!selectedProduct ? (
        <Loader />
      ) : (
          ...
          <div className="container m-auto">
            <div className="w-full px-4">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <h2 className="text-2xl my-3 font-bold text-sky_blue text-center">
                  write us a massege
                </h2>
                <div className="flex justify-between items-center gap-4 px-4 py-8">
                  <img className="w-24" src={selectedProduct.img} />
                ...
                <form ref={form} onSubmit={sendEmail}>
                  ...
                  <div className="relative top-0 right-0">
                    <span className="absolute right-8 text-gray-500 top-3 text-lg font-medium">
                      USD
                    </span>
                    <ContactInputBox
                      type="number"
...
const ContactTextArea = ({ row, placeholder, name, defaultValue, value }) => {
  return (
    <>
      <div className="mb-6">
        <textarea
