...
export default function Header() {
  ...
  return (
    <nav
      className={`py-5 px-6 shadow-sm  ease-linear duration-500  top-0 backdrop-blur-sm backdrop-filter   w-full ${
        parm.pathname === "/" ? " text-white" : "relative  shadow-sm "
      }  z-50 ${
        isSticky
          ? "bg-black/50 sticky  text-white "
    ...
    >
      ...
      >
        <ul
          ...
          }  absolute flex ease-in-out duration-700 bg-sky_blue w-full left-0  p-4 justify-center mt-5 space-x-2`}
        >
          <li>
        ...
        >
          ...
          >
            ...
            <Link to="/AllProducts" className="font-semibold text-lg">
              Product
            </Link>
          </NavLink>
          <NavLink
          ...
          >
            ...
            <Link to="/Subsrcribe" className="font-semibold text-lg">
              Subsrcribe
            </Link>
          </NavLink>
          <NavLink
      ...
      <div className="flex justify-between container items-center m-auto">
            ...
            <NavLink
              className={({ isActive }) =>
                isActive
                  ...
                  : "md:text-lg text-md hover:text-sky_blue  ease-in-out duration-300  font-semibold "
              }
              to={item.path}
              key={item.path}
            >
        ...
        <div className="flex gap-2 items-center justify-center">
          <AiOutlinePlus className="text-4xl   ease-in-out duration-300 rounded-full hover:text-white hover:bg-sky_blue  p-[6px] ml-1 cursor-pointer" />
          ...
          <AiOutlineMenu
            onClick={openlMenu}
            className={` text-4xl ease-in-out duration-300 rounded-full hover:text-white hover:bg-sky_blue  p-[6px] ml-1 cursor-pointer sm:hidden `}
          />
        </div>
      </div>
    </nav>
